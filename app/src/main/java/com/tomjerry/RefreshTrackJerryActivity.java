...
public class RefreshTrackJerryActivity extends ActionBarActivity {
 ...
 private String url1 = "http://167.205.32.46/pbd/api/track?nim=13512074";

 @Override
 protected void onCreate(Bundle savedInstanceState) {
 super.onCreate(savedInstanceState);
 setContentView(R.layout.activity_refresh_track_jerry);
 ...
 Intent i = new Intent(RefreshTrackJerryActivity.this,
 ...
 getMenuInflater().inflate(R.menu.menu_refresh_track_jerry, menu);
 return true;
 }
