package com.vidianindhita.tomandjerry;
...
public class MapsActivity extends ActionBarActivity implements SensorEventListener{
    ...
    private void setUpMap() {
        marker = mMap.addMarker(new MarkerOptions().position(Jerry).title("Jerry is here!"));
        marker.setIcon(BitmapDescriptorFactory.fromResource(R.drawable.jerry_location));
        mMap.setMyLocationEnabled(true);
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(Jerry,16.2f));
        mMap.getUiSettings().setMyLocationButtonEnabled(false);
    }

    private void setMarker(double latitude, double longitude) {
        marker.remove();
        Jerry = new LatLng(latitude, longitude);
        setUpMap();
    }
    ...
    public void GetLocation() {
        ...
        String url ="http://167.205.32.46/pbd/api/track?nim=13512034";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Long valid = data.getLong("valid_until");
                            ...
                            new CountDownTimer(valid*1000-now, 1000)
                            {
                                ...
                                public void onTick(long millisUntilFinished) {
                                    ...
                                    clock.setText("Remaining time " + day + ":" + hour + ":" + minute + ":" + second);
                                }
    ...
    public void SendLocation(final String token) {
        // Instantiate the RequestQueue.
        RequestQueue queue = Volley.newRequestQueue(this);
