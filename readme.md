...
Aplikasi ini digunakan untuk membantu Tom dalam mencari dan menangkap Jerry. Aplikasi android ini dibuat untuk berkomunikasi dengan Spike untuk mengetahui lokasi dan lama persembunyian Jerry di lokasi tersebut. Aplikasi itu juga dapat melaporkan penangkapan Jerry kepada Spike.
...
$ Fungsi ini untuk mendapatkan data dari server. Data yang diambil adalah posisi Jerry dalam LatLng(latitude, longitude) dan waktu expired (valid_until)
...
$ Fungsi ini untuk mengirimkan pesan ke server sebagai hasil dari QR Code. Hasil dari yang dikirim akan dikembalikan tiga buah nilai. Berikut adalah status response-nya.
